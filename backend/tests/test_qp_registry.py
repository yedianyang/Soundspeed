...
_QP_NAMES = ["count_takes", "get_scene_info", "list_characters", "search_script_lines", "list_scenes", "get_scene_script", "query_database"]
...
def test_list_tools_exact_ten() -> None:
    """注册表恰好 10 个工具，不多不少（防意外重复注册或丢失）。"""
